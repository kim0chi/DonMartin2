...
{
    public partial class form_CustomerAccount : Form
    {
        public form_CustomerAccount()
        {
            InitializeComponent();
        }
        ...
        private void form_CustomerAccount_Load(object sender, EventArgs e)
        {
            AddCategory();
        ...
        private void btn_Kitchen_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@WaiterName", "Kiosk");
            cmd.Parameters.AddWithValue("@status", "Pending");
            cmd.Parameters.AddWithValue("@orderType", "Kiosk");
        ...
        private void btn_TakeOut_Click(object sender, EventArgs e)
        {
            ...
            add.MainID = MainID;
            MainClass.BlurBackgroundPOS(main, add);
